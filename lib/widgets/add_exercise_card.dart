        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(
              color: Color.fromARGB(255, 64, 6, 173),
          ...
          ClipRRect(
            borderRadius: BorderRadius.circular(15),
            child: Image.asset(widget.image, fit: BoxFit.cover, width: 100),
          ),
          if (!widget.showMore)
            Text(
          ...
          if (widget.showMore)
            const Text(
              ...
              style: TextStyle(
                fontSize: 15,
                color: Color.fromARGB(255, 188, 221, 20),
              ),
            ),
          const SizedBox(height: 10),
          Padding(
                  ...
                  child: Center(
                    child: IconButton(
                      icon: Icon(
                        ...
                        size: 30,
                        color: const Color.fromARGB(255, 26, 176, 66),
                      ),
                      onPressed: () {
