    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [
            Color.fromARGB(255, 35, 81, 190),
            Color.fromARGB(255, 14, 75, 167),
          ],
        ),
      ),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(
              height: 10,
            ), // Add some space between text and progress bar
            LinearProgressIndicator(
              ...
              backgroundColor: const Color.fromARGB(
                ...
                212,
                244,
              ), // Grey color for unfilled region
              valueColor: const AlwaysStoppedAnimation<Color>(
                Color.fromARGB(255, 240, 15, 15),
              ),
            ...
            const SizedBox(
              height: 10,
            ), // Add some space between progress bar and tags
            Row(
